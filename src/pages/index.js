        ...
        <div className='container px-4 px-lg-5 d-flex h-100 align-items-center justify-content-center'>
          <div className='d-flex justify-content-center'>
            <div className='text-center'>
              <h1 className='mx-auto my-0 text-uppercase bg-warning'>
                PED
              </h1>
          ...
          <div className='row gx-4 gx-lg-5 justify-content-center'>
            <div className='col-lg-8'>
              ...
              <p className='text-white-50'>
                Welcome to Patrick Events and Decor, where
                we transform events into unforgettable
                experiences through our exceptional decor
                services. With a passion for creativity and
                an unwavering commitment to excellence, we
                take pride in making every occasion special.
                ...
                <div className='carousel-inner'>
                  <div className='carousel-item '>
                    ...
                    <div className='carousel-caption text-white'>
                      <p editable='inline'>
                        At Patrick Events & Decor, we
                        specialize in delivering top-notch
                        launch services tailored to make
                        your product or service introduction
                        unforgettable. Our comprehensive
                        launch services ensure every aspect
                        of your event is meticulously
                        planned and executed, creating a
                        lasting impression on your audience.
                        Here's what our launch services
                        include:
                      </p>
                      <h5 editable='inline'>
                      ...
                      <p editable='inline'>
                        <ul>
                          <li>
                            ...
                            develop a unique concept that
                            aligns with your brand's
                          ...
                          <li>
                            ...
                            From selecting the perfect venue
                            to coordinating with vendors,
                            our team handles all the
                            logistics to ensure your launch
                            event runs smoothly.
                          </li>
                          <li>
                            <strong>
                            ...
                            stunning visuals and themes that
                      ...
                      <p editable='inline'>
                        <ul>
                          ...
                          <li>
                            ...
                            We assist in developing and
                            executing effective marketing
                            strategies to generate buzz and
                            attract the right audience for
                            your launch.
                          </li>
                          <li>
                            <strong>
                            ...
                            Our experienced coordinators are
                            on-site to manage every detail,
                            ensuring your event is seamless
                            and successful.
                          </li>
                        </ul>
                      </p>
                ...
                <div className='d-flex h-100'>
                  <div className='project-text w-100 my-auto text-center text-lg-left'>
                    ...
                    <p className='mb-0 text-white-50'>
                      We create the perfect atmosphere for
                      your event with our extensive range of
                      tents and chairs. Whether it's an
                      intimate gathering or a grand
                      celebration, we have the right
              ...
              <div className='bg-danger text-center h-100 project'>
                <div className='d-flex h-100'>
                  <div className='project-text w-100 my-auto text-center text-lg-right'>
                    ...
                    <p className='mb-0 text-white-50'>
                      Illuminate your event with our
                      breathtaking lighting solutions. From
                      elegant ambient lighting to vibrant
                      color display, we bring your vision to
                      life and set the mood for an
              ...
              <div className='bg-danger text-center h-100 project'>
                <div className='d-flex h-100'>
                  <div className='project-text w-100 my-auto text-center text-lg-left'>
                    ...
                    <p className='mb-0 text-white-50'>
                      Ensure your message is heard and clear
                      with our state-of-art public address
                      systems. Elevate your event with
                      captivating visual solutions,
                      including screens and display, to
              ...
              <div className='bg-danger text-center h-100 project'>
                <div className='d-flex h-100'>
                  <div className='project-text w-100 my-auto text-center text-lg-right'>
                    ...
                    <p className='mb-0 text-white-50'>
                      Capture the moments that matter with
                      our professional photography and
                      videography services. Our skilled team
                      ensures every detail is preserved,
                      allowing you to relive the magic of
                      your event for tears to come!
                    </p>
                  </div>
                </div>
              </div>
